...
# Ensure 'cpd_id' and 'Library' exist
if "cpd_id" in experiment_data.columns and "Library" in experiment_data.columns:
    experiment_data = experiment_data.set_index(["cpd_id", "Library"])

if "cpd_id" in stb_data.columns and "Library" in stb_data.columns:
    stb_data = stb_data.set_index(["cpd_id", "Library"])
