...
SCRIPT="/Users/PThorpe001/github_repos/cell_painting_sperm/anomaly_detection/aggregate_cellprofiler_to_profiles.py"
...
for FOLDER in "${FOLDERS[@]}"; do
    ...
    python /Users/PThorpe001/github_repos/cell_painting_sperm/anomaly_detection/aggregate_cellprofiler_to_profiles.py \
        --input_dir "$FOLDER" \
        --output_file "$FOLDER/merged.tsv" \
...
MERGED_OUT="all_plates_merged.tsv"
MERGED_LOG="merge_profiles.log"
...
python /Users/PThorpe001/github_repos/cell_painting_sperm/anomaly_detection/merge_cellprofiler_well_level_profiles.py \
    --input_files $(for FOLDER in "${PLATES[@]}"; do echo -n "$FOLDER/merged.tsv "; done) \
